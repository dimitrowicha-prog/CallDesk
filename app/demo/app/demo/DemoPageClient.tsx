...
export default function DemoPageClient({
  ...
  // по желание: бърз debug в console
  useEffect(() => {
    ...
    <div className="pt-32 pb-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* по желание: показвай OAuth статус */}
          {google === "ok" && (
          ...
          >
            ...
            <Card className="p-8 bg-black text-white">
              ...
              <p className="text-gray-300 mb-6">
                След демото, ако решите да продължите, получавате пълен достъп до
                всички функции за 14 дни. Няма нужда от кредитна карта.
              </p>
